  ...
  return (
    <Wrapper>
      ...
      <Content>
        <InfoSection
          ...
          details={[
            {
              label: '공급규모',
              value: `${announcement?.tot_suply_hshldco}세대`,
            },
        ...
        <ScheduleB
          items={[
            {
              label: '모집공고일',
              value: formatDateString(announcement?.rcrit_pblanc_de),
            },
            {
              label: '청약접수',
            ...
            {
              label: '당첨자 발표일',
              value: formatDateString(announcement?.przwner_presnatn_de),
            },
            {
              label: '계약일',
      ...
      <ApplyButton
        ...
        initialLiked={announcement?.isLiked ?? false}
        pblancNo={pblanc_no}
        houseManageNo={house_manage_no}
        userId={1}
      />
